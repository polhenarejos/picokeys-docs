...
This document explains how to use Smart Card Shell 3 (SCS3) with Pico HSM, based directly on the official Pico HSM documentation.

SCS3 is an interactive shell that allows sending APDU commands and inspecting smart card behavior.

## Overview

Smart Card Shell 3 provides:

- Interactive APDU execution
- Scriptable smart card workflows
- Low-level inspection and debugging

!!! note
    SCS3 is intended for advanced users and development or debugging scenarios.
